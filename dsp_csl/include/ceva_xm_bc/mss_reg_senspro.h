...
typedef enum
{
	OCEM_MEM_CONFIG_REG             = 0x158,      /**< senspro - OCEM Memory Configuration Register */
	MSS_PMSS_PCR_ADDR               = 0x400,      /**< senspro - PMSS PDMA Program Control Register */
	MSS_PMSS_HDCFG                  = 0x408,      /**< senspro - PMSS HDCFG Register */
    MSS_PMSS_PDEA_ADDR              = 0x410,      /**< senspro - PMSS PDMA External Address Register */
    MSS_PMSS_PDIA_ADDR              = 0x414,      /**< senspro - PMSS PDMA Internal Address Register */
    MSS_PMSS_PDTC_ADDR              = 0x418,      /**< senspro - PMSS PDMA Transfer Control */
    MSS_PMSS_PADD_START_BASE_ADDR   = 0x420,      /**< senspro - PMSS Memory Region Start Base Address Register*/
	MSS_PMSS_PADD_ATT0_BASE_ADDR    = 0x424,      /**< senspro - PMSS Memory Region Attribute Base Register*/
	MSS_PMSS_CCOSAR_ADDR            = 0x4e0,      /**< senspro - PMSS Instruction Cache Operations Start Address Register*/
	MSS_PMSS_CCOCR_ADDR             = 0x4e4,      /**< senspro - PMSS Instruction Cache Operations Configuration Register*/
	MSS_PMSS_ECADD_ADDR             = 0x4f0,      /**< senspro - PMSS ECC Error Address Register*/
	//Not found in senspro: MSS_PMSS_MAPAR_ADDR             = 0xc80,      /**< senspro - PMSS Program Memory Access Protection Address Register*/
	//Not found in senspro: MSS_PMSS_MAPSR_ADDR             = 0x524,      /**< PMSS Program Memory Access Protection Status Register*/
	MSS_PMSS_SYS_OU_C_ADDR          = 0x404,      /**< senspro - (MSS_PMSS_AXI_OU_C_ADDR*)PMSS PDMA Outstanding And Burst Size Configuration Register*/
	//Not found in senspro: MSS_PMSS_MECCCOR_ADDR           = 0x530,      /**< PMSS AXI Master ECC COR Data Address Register*/
	MSS_PMSS_PMSSACS_ADDR           = 0x540,      /**< senspro - PMSS Enable Access To PMSS Shadow Registers Register*/
	
	MSS_DMSS_DMBA_ADDR              = 0x600,      /**< senspro - DMSS Data Memory Base Address Register*/
	MSS_DMSS_DMBE_ADDR              = 0x604,      /**< senspro - DMSS Data Memory Status Register*/
	MSS_DMSS_HDCFG_ADDR             = 0x61C,      /**< senspro - DMSS Hardware Memory Configuration Register*/
	MSS_DMSS_DACC_ADDR              = 0x628,      /**< senspro - DMSS DMA Outstanding Configuration Register*/
	MSS_DMSS_SDCFG_ADDR             = 0x62C,      /**< senspro - DMSS SDCFG Register*/
	MSS_DMSS_DDTC_ADDR              = 0x658,      /**< senspro - DMSS DDTC*/
	MSS_DMSS_2DCFG1_ADDR            = 0x660,      /**< senspro - DMSS 2D Memory Configuration First Register*/
	MSS_DMSS_2DCFG2_ADDR            = 0x664,      /**< senspro - DMSS 2D Memory Configuration Second Register*/
	MSS_DMSS_2DCFG3_ADDR            = 0x668,      /**< senspro - DMSS 2D Memory Configuration 3rd Register*/
    MSS_DMSS_2DCFG4_ADDR            = 0x66c,      /**< senspro - DMSS 2D Memory Configuration 4th Register*/
    MSS_DMSS_2DCFG5_ADDR            = 0x670,      /**< senspro - DMSS 2D Memory Configuration 5th Register*/
    MSS_DMSS_2DCFG6_ADDR            = 0x674,      /**< senspro - DMSS 2D Memory Configuration 6th Register*/
    MSS_DMSS_DDQS_ADDR              = 0x678,      /**< senspro - DMSS DDQS*/
	MSS_DMSS_DDEA_ADDR              = 0x680,      /**< senspro - DMSS DDEA*/
	MSS_DMSS_DDIA_ADDR              = 0x684,      /**< senspro - DMSS DDIA*/
	MSS_DMSS_DDCL_ADDR              = 0x68c,      /**< senspro - DMSS DDCL*/
	MSS_DMSS_DDMA_PAUSE_ADDR        = 0x690,      /**< senspro - DMSS DDMA Pause*/
	//GVI registers are different in senspro
	...
	MSS_CENSIRQ_ADDR                = 0xd10,      /**< senspro - Critical General Violation First Register*/
	MSS_CENSIRQ2_ADDR               = 0xd14,      /**< senspro - Critical General Violation Second Register*/
	MSS_NENSIRQ_ADDR                = 0xd1c,      /**< senspro - Normal General Violation Register*/
	MSS_DMA_IRQ_ADDR                = 0xd24,      /**< senspro - DMA interrupt source*/
	MSS_CENSIRQ_MASK_ADDR           = 0xd30,      /**< senspro - Critical General Violation First Mask Register*/
	MSS_CENSIRQ2_MASK_ADDR          = 0xd34,      /**< senspro - Critical General Violation Second Mask Register*/
	MSS_NENSIRQ_MASK_ADDR           = 0xd3c,      /**< senspro - Normal General Violation Mask Register*/
	
	MSS_PSU_PSVM_ADDR               = 0xE50,      /**< senspro - PSU Save Mode Register*/
	//Not found in senspro: MSS_PSU_PGR_ADDR                = 0xE54,      /**< PSU General Register*/
	
	MSS_AP_MAPAR_ADDR               = 0xC80,      /**< senspro - P Memory Access Protection Address Register*/
	//Not found in senspro: MSS_AP_MAPSR_ADDR               = 0xC84,      /**< AP Memory Access Protection Status Register*/
	MSS_AP_DTAP_ADDR                = 0xC88,      /**< senspro - AP TCM Access Protection Register*/
	
	MSS_IC_ADD_START_BASE_ADDR      = 0x920,      /**< senspro - Memory Region Start Address Base Register*/
	MSS_IC_ADD_ATT0_BASE_ADDR       = 0x924,      /**< senspro - Memory Region Attribute 0 Base Register*/
	MSS_IC_ADD_ATT1_BASE_ADDR       = 0x928,      /**< senspro - Memory Region Attribute 1 Base Register*/
	
	//System WD is different in senspro
	...
	MSS_WD_CNT                        = 0x718     /**< senspro - WD MSS System Clock upper part Register, Timer count = 16 * WD_CNT*/
}   mss_regs_addr_e;
...
typedef union {
	struct  {
	    ...
	    /**
	         Width of AXI slave 0 port:
	 	    - 00: disabled
	 	    - 01: 128 bits
	 	    - 10: 256 bits
	 	    - 11: Reserved */
	 	unsigned s0_axi_width : 2;


	    /**
	         Width of AXI slave 1 port:
	 	    - 00: disabled
	 	    - 01: 128 bits
	 	    - 10: 256 bits
	 	    - 11: Reserved */
	 	unsigned s1_axi_width : 2;


	    /**
	         Width of AXI slave 2 port:
	 	    - 00: disabled
	 	    - 01: 128 bits
	 	    - 10: 256 bits
	 	    - 11: Reserved */
	 	unsigned s2_axi_width : 2;

	    /**
	         Width of AXI Master 0/1 port:
	 	    - 00: disabled
	 	    - 01: 128 bits
	 	    - 10: 256 bits
	 	    - 11: Reserved */
	 	unsigned mstr_axi_width : 2;


	    /**
	      Program error correction code */
	 	unsigned pecc : 1;


        unsigned other : 6;               /**< Other fields */

    } field;                         /**< Fields view */
    uint32_t  overlay;           /**< Overlay view */
} mss_hardware_d_memory_config_reg_t;

/**
* @brief Hardware Program Memory Configuration register (P_HDCFG)
*/
typedef union {
	struct  {
		/**
        ...
        unsigned reserved3 : 20;               /**< Other fields */

        unsigned l1ICA : 2;

    } field;                         /**< Fields view */
    uint32_t  overlay;           /**< Overlay view */
} mss_hardware_p_memory_config_reg_t;
