...
typedef enum
{
	...
	MSS_DMSS_DDEA_ADDR              = 0x61c,      /**< DMSS DDEA register*/
	MSS_DMSS_DDIA_ADDR              = 0x620,      /**< DMSS DDIA register*/
	MSS_DMSS_DDTC_ADDR              = 0x624,      /**< DMSS DDIA register*/
	MSS_DMSS_DDQS_ADDR              = 0x628,      /**< DMSS DDQS register*/
