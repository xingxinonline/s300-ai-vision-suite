...
#ifdef XM4
	#define CSL_HW_CONFIG_BANK_ALIGN 0x3
    #if CEVA_DSP_RTL >= 120
        #include "mss_reg_xm4_1.2.h"
		#define DDCL_DESCRIPTOR
    #else // CEVA_DSP_RTL < 120
        #include "mss_reg_xm4.h"
    #endif  // CEVA_DSP_RTL < 120
#elif defined XM6
    #include "mss_reg_xm6.h"
	#define CSL_HW_CONFIG_BANK_ALIGN 0x3
	#define DDCL_DESCRIPTOR
	#define CLIPPING_PACKING_DESCRIPTOR
#elif defined SENSPRO
    #include "mss_reg_senspro.h"
#else
	#error Unsupported platform
#endif

#ifndef MSS_P_RG_OFFSET
	#define MSS_P_RG_OFFSET 0x10
#endif
...
#else
/**
 * @brief Memory regions enumeration<BR>In program memory only 8 memory regions are available
 *
 */
typedef enum
{
    MSS_P_MEMORY_REGION_0 = 0x0,              /**< Memory region number 0. */
	MSS_P_MEMORY_REGION_1 = MSS_P_MEMORY_REGION_0 + MSS_P_RG_OFFSET,             /**< Memory region number 1. */
	MSS_P_MEMORY_REGION_2 = MSS_P_MEMORY_REGION_1 + MSS_P_RG_OFFSET,             /**< Memory region number 2. */
	MSS_P_MEMORY_REGION_3 = MSS_P_MEMORY_REGION_2 + MSS_P_RG_OFFSET,             /**< Memory region number 3. */
	MSS_P_MEMORY_REGION_4 = MSS_P_MEMORY_REGION_3 + MSS_P_RG_OFFSET,             /**< Memory region number 4. */
	MSS_P_MEMORY_REGION_5 = MSS_P_MEMORY_REGION_4 + MSS_P_RG_OFFSET,             /**< Memory region number 5. */
	MSS_P_MEMORY_REGION_6 = MSS_P_MEMORY_REGION_5 + MSS_P_RG_OFFSET,             /**< Memory region number 6. */
	MSS_P_MEMORY_REGION_7 = MSS_P_MEMORY_REGION_6 + MSS_P_RG_OFFSET,             /**< Memory region number 7. */
	MSS_P_MEMORY_REGION_8 = MSS_P_MEMORY_REGION_7 + MSS_P_RG_OFFSET,             /**< Memory region number 8. */
	MSS_P_MEMORY_REGION_9 = MSS_P_MEMORY_REGION_8 + MSS_P_RG_OFFSET,             /**< Memory region number 9. */
	MSS_P_MEMORY_REGION_10 = MSS_P_MEMORY_REGION_9+ MSS_P_RG_OFFSET,            /**< Memory region number 10. */
	MSS_P_MEMORY_REGION_11 = MSS_P_MEMORY_REGION_10+ MSS_P_RG_OFFSET,            /**< Memory region number 11. */
	MSS_P_MEMORY_REGION_12 = MSS_P_MEMORY_REGION_11+ MSS_P_RG_OFFSET,            /**< Memory region number 12. */
	MSS_P_MEMORY_REGION_13 = MSS_P_MEMORY_REGION_12+ MSS_P_RG_OFFSET,            /**< Memory region number 13. */
	MSS_P_MEMORY_REGION_14 = MSS_P_MEMORY_REGION_13+MSS_P_RG_OFFSET,            /**< Memory region number 14. */
	MSS_P_MEMORY_REGION_15 = MSS_P_MEMORY_REGION_14+MSS_P_RG_OFFSET,            /**< Memory region number 15. */
} mss_p_mem_region_e;

typedef enum
{
    MSS_D_MEMORY_REGION_0 = 0x0,              /**< Memory region number 0. */
	MSS_D_MEMORY_REGION_1 = 0x10,             /**< Memory region number 1. */
	MSS_D_MEMORY_REGION_2 = 0x20,             /**< Memory region number 2. */
	MSS_D_MEMORY_REGION_3 = 0x30,             /**< Memory region number 3. */
	MSS_D_MEMORY_REGION_4 = 0x40,             /**< Memory region number 4. */
	MSS_D_MEMORY_REGION_5 = 0x50,             /**< Memory region number 5. */
	MSS_D_MEMORY_REGION_6 = 0x60,             /**< Memory region number 6. */
	MSS_D_MEMORY_REGION_7 = 0x70,             /**< Memory region number 7. */
	MSS_D_MEMORY_REGION_8 = 0x80,             /**< Memory region number 8. */
	MSS_D_MEMORY_REGION_9 = 0x90,             /**< Memory region number 9. */
	MSS_D_MEMORY_REGION_10 = 0xA0,            /**< Memory region number 10. */
	MSS_D_MEMORY_REGION_11 = 0xB0,            /**< Memory region number 11. */
	MSS_D_MEMORY_REGION_12 = 0xC0,            /**< Memory region number 12. */
	MSS_D_MEMORY_REGION_13 = 0xD0,            /**< Memory region number 13. */
	MSS_D_MEMORY_REGION_14 = 0xE0,            /**< Memory region number 14. */
	MSS_D_MEMORY_REGION_15 = 0xF0,            /**< Memory region number 15. */
} mss_d_mem_region_e;
#endif
/**
 ...
 *
 */
typedef uint32_t mss_access_protection_t;
 ...
 */
typedef uint32_t mss_mem_region_l2_cache_policy_t;
...
typedef union
{
 ...
 struct {
	...
	uint32_t start_address;                                 /**< The memory region start address. Must be aligned to 4096 bytes. The end address is defined by next memory region start address */
	uint32_t p_region_start				:20;              	                /**< The memory region start address. Must be aligned to 4096 bytes. The end address is defined by the next memory region start address.*/
	uint32_t 				:8;	 // Reserved

	mss_mem_region_active_e active :1;                             /**< Activate the memory region */
	uint32_t 				:3;	 // Reserved

	mss_program_mem_region_cacheability_e cache_enable :1; 	    /**< Enable cache for memory region */

	mss_program_mem_region_lock_after_line_fill_e cache_lock :1; 	/**< Lock after cache-line fill */
	uint32_t 				:2;	// Reserved
#ifdef SENSPRO
	mss_access_protection_t access_protection :2; 	                /**< Memory access protection */
	uint32_t 				:2;	// Reserved
#else
	mss_access_protection_t access_protection :3; 	                /**< Memory access protection */
	uint32_t 				:1;	// Reserved
#endif
	mss_mem_region_l2_cache_policy_t l2_cache_policy :4; 	        /**< L2 Cache Policy */
	uint32_t 				:12;	// Reserved

    uint32_t qos :4; 	                                        /**< Quality of Service, used as a priority indicator for the associated read transaction.
...
#else
	mss_p_mem_region_e memory_region;
#endif
	};
 struct{
		uint32_t start_address;                                 /**< The memory region start address. Must be aligned to 4096 bytes. The end address is defined by next memory region start address */
	 	T_pmss_region_attributes region_attributes;
...
typedef union
{
	 struct {
		...
		uint32_t start_address					:32;              	                /**< The memory region start address. Must be aligned to 4096 bytes. The end address is defined by the next memory region start address.*/
		uint32_t regoin_start					:20;              	                /**< The memory region start address. Must be aligned to 4096 bytes. The end address is defined by the next memory region start address.*/
		mss_data_mem_region_master_id_e master_id 	:8;                  /**< The memory region master ID */
		...
		mss_data_memory_ordering_model_e memory_ordering :1; 	        /**< Memory ordering model - total store or strong ordering */

		mss_access_protection_t access_protection	:3;                  /**< Memory access protection */
		uint32_t									: 4;	// Reserved

	    uint32_t read_qos						:4;                	                    /**< Read Quality of Service, used as a priority indicator for the associated read transaction.
		                                                                QoS range is 0-15, a higher value indicates a higher priority */

		uint32_t write_qos						:4;                                     /**< Write Quality of Service, used as a priority indicator for the associated write transaction.
		                                                                QoS range is 0-15, a higher value indicates a higher priority */

		mss_ddma_read_policy_e ddma_read_policy		 :1 ;                    /**< DDMA external port read policy */

		mss_mem_region_l2_cache_policy_t l2_cache_write_policy: 4; 	/**< L2 Cache Policy for write accesses */

		mss_mem_region_l2_cache_policy_t l2_cache_read_policy	:4 ;      /**< L2 Cache Policy for read accesses */

		mss_data_mem_region_max_burst_size_e ddma_max_burst_size	:4;   /**< Maximum DDMA burst size for this region */

		mss_ddma_region_max_outstanding_read_e ddma_max_outstanding_read:4; 	/**< Maximum outstanding DDMA read AXI bursts */
		uint32_t									: 1;	// Reserved

		mss_ddma_region_max_outstanding_write_e ddma_max_outstanding_write :3; /**< Maximum outstanding DDMA write AXI bursts */
		uint32_t 									: 11;	// Reserved

		#ifndef SENSPRO
			mss_mem_region_e memory_region;                             /**< The memory region for which the desired address and attributes are set */
		#else
			mss_d_mem_region_e memory_region;
		#endif
	};
	 struct{
		uint32_t start_address					:32;              	                /**< The memory region start address. Must be aligned to 4096 bytes. The end address is defined by the next memory region start address.*/
		T_dmss_region_attributes region_attributes;
		uint32_t memory_region;
	} csl_safety;
...
* @return void
*/
#define mss_write_reg(reg, value)  cpm_out1(reg, value)
...
* @return void
*/
#define mss_set_software_operation_program_cache_config(_start_address,_operation_type,_operation_size, _cache_lines_num)\
			(P_CCOCR_P_OS_ADDRESS_BASED ==_operation_size)? PMSS_set_swop_address_based(_start_address, (E_p_ccocr_p_ot)_operation_type, (uint16_t)_cache_lines_num) : PMSS_set_swop_entire_cache((E_p_ccocr_p_ot)_operation_type);
...
* @return void
*/
#define mss_enable_global_program_cache() PMSS_enable_global_program_cache_bc()
...
*/
#ifdef SENSPRO
	#define mss_get_program_access_violation_address() -1
#else
	#define mss_get_program_access_violation_address()		(HW_EXCPTIONS_get_program_access_violation_address() | HW_EXCPTIONS_clear_program_access_violation_address())
#endif


extern uint32_t IDM_size;
extern uint32_t IPM_size;
extern uint32_t P_cache_size;
...
* @return the address value (if no violation occurred the return value is 0)
*/
#define mss_get_data_access_violation_address() (HW_EXCPTIONS_get_data_access_violation_address() | HW_EXCPTIONS_clear_data_access_violation_address())

/**
* @brief Gets the internal program memory size
* @return the size of the internal program memory in bytes
*/
#define mss_get_internal_program_memory_size()\
		IPM_size
...
*/
#define mss_get_internal_data_memory_size()\
		IDM_size
...
*/
#define mss_get_program_cache_size()\
		P_cache_size
...
* @return void
*/
#define mss_set_ddma_global_max_outstanding(_outstanding_read, _outstanding_write)\
		DMSS_set_ddma_global_max_outstanding((E_mss_dacc_dol)_outstanding_read, (E_mss_dacc_uol)_outstanding_write)
...
* @return void
*/
#define mss_set_power_save_mode(_mode)      CSL_set_power_save_mode((E_psvm_pmod)_mode)
...
*/
#ifndef SENSPRO_V1_2
	#define mss_set_access_protection(_program_access_protection, _data_access_protection) (PMSS_set_access_protection((E_mss_pcr_pape)_program_access_protection) | DMSS_set_access_protection((E_mss_sdcfg_dape)_data_access_protection))
#else
	#define mss_set_access_protection(_program_access_protection, _data_access_protection)
#endif

/**
* @brief Maximum supported PDMA transfer size<BR>
*/
#define MSS_MAX_PDMA_TRANSFER_SIZE   (0xFFFE0)


/**
* @brief Load program to the internal program memory with interrupt configuration<BR>
* This function uses the program DMA with interrupt configuration.
...
* @param[in]     en_int - Enable interrupt, 1 - to enable interrupt at the end of the transfer, 0 - to disabled.
* @return void
*/
#define mss_load_internal_program_interruptable(_int_address,  _ext_address, _size, _en_interrupt)\
		PMSS_set_pdma_task_bc(_int_address, _ext_address, _size, _en_interrupt)
...
* @return void
*/
#define mss_load_internal_program( int_address, ext_address, size)\
		mss_load_internal_program_interruptable( int_address,  ext_address,  size,  1)
...
*/
#ifdef SENSPRO
#define mss_get_clock() 0
#else /* !SENSPRO */
#define mss_get_clock() WATCHDOG_get_mss_system_clock()
#endif /* SENSPRO */
...
*/
#ifdef SENSPRO
	#define mss_set_program_memory_region(_region_settings)\
			(_region_settings)->csl_safety.region_attributes.fields.p_region_start = ((_region_settings)->start_address >> 12);\
			PMSS_set_region_attributes_bc(((_region_settings)->memory_region >> 2),  ((_region_settings)->csl_safety.region_attributes));
#else /* !SENSPRO */
	#define mss_set_program_memory_region(_region_settings)\
			(_region_settings)->csl_safety.region_attributes.fields.p_region_start = ((_region_settings)->start_address >> 12);\
			PMSS_set_region_attributes_bc(((_region_settings)->memory_region >> 4),  ((_region_settings)->csl_safety.region_attributes));
#endif /* SENSPRO */
...
* @return void
*/
#define mss_set_data_memory_region(_region_settings)\
		(_region_settings)->csl_safety.region_attributes.fields.region_start = ((_region_settings)->start_address >> 12);\
		DMSS_set_region_attributes(((_region_settings)->memory_region >> 4),  &((_region_settings)->csl_safety.region_attributes));

/**
* @brief reports if the mss has pending pdma interrupt
* @return 1 - if pdma interrupt is pending, 0 - otherwise.
*/
#define    mss_has_pdma_interrupt_pending()  		HW_EXCPTIONS_get_pdma_irq_status()

/**
* @brief clear pdma interrupt pending indication from the mss
* @return  void
*/
#define    mss_clear_pdma_interrupt_pending()		HW_EXCPTIONS_clear_pdma_irq_status()

/**
* @brief reports if the mss has pending ddma interrupt
* @return 1 - if ddma interrupt is pending, 0 - otherwise.
*/
#define  mss_has_ddma_interrupt_pending() 			HW_EXCPTIONS_get_ddma_irq_status()

/**
* @brief clear ddma interrupt pending indication from the mss
* @return  void
*/
#define    mss_clear_ddma_interrupt_pending()			HW_EXCPTIONS_clear_ddma_irq_status()
