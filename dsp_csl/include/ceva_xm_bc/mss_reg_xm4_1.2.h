...
/**
@file mss_reg.h
@brief CEVA-XM4 RTL 1.2.x MSS (Memory Sub-System) driver register map
*/
...
typedef enum
{
	OCEM_MEM_CONFIG_REG             = 0x17c,        /**< OCEM Memory/Core Configuration Register*/
	...
	MSS_DMSS_SDCFG_ADDR             = 0x650,      /**< DMSS SDCFG Register*/
	MSS_DMSS_DDIA_ADDR              = 0x664,      /**< DMSS DDIA Register */
	MSS_DMSS_DDEA_ADDR              = 0x668,      /**< DMSS DDEA Register */
	MSS_DMSS_DDTC_ADDR              = 0x66c,      /**< DMSS DDTC Register */
	MSS_DMSS_2DCFG1_ADDR            = 0x670,      /**< DMSS 2D Memory Configuration First Register*/
	MSS_DMSS_2DCFG2_ADDR            = 0x674,      /**< DMSS 2D Memory Configuration Second Register*/
	MSS_DMSS_2DCFG3_ADDR            = 0x678,      /**< DMSS 2D Memory Configuration Third Register*/
	MSS_DMSS_DDCL_ADDR              = 0x688,      /**< DMSS DDQS Register*/
	MSS_DMSS_DDQS_ADDR              = 0x68c,      /**< DMSS DDQS Register*/
	...
	MSS_WD_SYSTIML_ADDR             = 0xa10,      /**< WD MSS System Clock lower part Register*/
	MSS_WD_SYSTIMH_ADDR             = 0xa14       /**< WD MSS System Clock upper part Register*/
}   mss_regs_addr_e;
...
typedef union {
	struct  {
        ...
        /**
        Width of AXIs0 slave port:
	    - 00: Slave port 0 is disabled
	    - 01: 128 bits
	    - 10: 256 bits
	    - 11: Reserved */
	    unsigned axi_s0_width : 2;

        /**
        Width of AXIs1 slave port:
	    - 00: Slave port 1 is disabled
	    - 01: 128 bits
	    - 10: 256 bits
	    - 11: Reserved */
	    unsigned axi_s1_width : 2;

        /**
        Width of AXIs2 slave port:
	    - 00: Slave port 2 is disabled
	    - 01: 128 bits
	    - 10: 256 bits
	    - 11: Reserved */
	    unsigned axi_s2_width : 2;

        /**
        Width of AXIm0/1 master ports:
	    - 00: Master ports are disabled
	    - 01: 128 bits
	    - 10: 256 bits
	    - 11: Reserved */
	    unsigned axi_m_width : 2;
...
typedef union {
	struct {
        ...
        /** PTCM retention indication */
        unsigned ret_ptcm : 1;

        /** PMSS Cache and tag retention indication */
        unsigned ret_pcac : 1;

        /** DTCM block 0 retention indication */
        unsigned ret_dtcm0 : 1;

        /** DTCM block 1 retention indication */
        unsigned ret_dtcm1 : 1;

        /** DTCM block 2 retention indication */
        unsigned ret_dtcm2 : 1;

        /** DTCM block 3 retention indication */
        unsigned ret_dtcm3 : 1;

        /** Core and MSS shutdown indication */
        unsigned shtdwn_dsp : 1;

        /** PTCM shutdown indication */
        unsigned shtdwn_ptcm : 1;

        /** PMSS Cache and tag shutdown indication */
        unsigned shtdwn_pcac : 1;

        /** DTCM block 0 shutdown indication */
        unsigned shtdwn_dtcm0 : 1;

        /** DTCM block 1 shutdown indication */
        unsigned shtdwn_dtcm1 : 1;

        /** DTCM block 2 shutdown indication */
        unsigned shtdwn_dtcm2 : 1;

        /** DTCM block 3 shutdown indication */
        unsigned shtdwn_dtcm3 : 1;
