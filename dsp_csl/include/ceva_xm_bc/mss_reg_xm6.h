...
typedef enum
{
	...
	MSS_DMSS_DDTC_ADDR              = 0x658,      /**< DMSS DDTC register*/
	...
	MSS_DMSS_DDQS_ADDR              = 0x678,      /**< DMSS DDQS register*/
	MSS_DMSS_DDEA_ADDR              = 0x680,      /**< DMSS DDEA register*/
	MSS_DMSS_DDIA_ADDR              = 0x684,      /**< DMSS DDIA register*/
	MSS_DMSS_DDCL_ADDR              = 0x68c,      /**< DMSS DDCL register*/
